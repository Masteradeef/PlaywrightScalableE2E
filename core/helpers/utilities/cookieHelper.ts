...
export class CookieHelper {
  ...
  /**
   * Add common legacy cookies for legacy Trader experience
   */
  async addCommonLegacyCookies(): Promise<void> {
    await this.addCookies([
      {
        name: 'om',
        value: 'autotrader-control-dec-1',
        domain: '.autotrader.ca',
        path: '/',
        expires: Math.floor(Date.now() / 1000) + 86400,
        secure: true,
