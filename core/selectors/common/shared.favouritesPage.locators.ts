// shared.favouritesPage.locators.ts
...
export abstract class BaseFavouritesPageLocators {
  ...
  removeFromFavouritesButtons = () => this.page.locator('button[aria-label="Remove from Favourites"], button[aria-label="Supprimer des favoris"]');
