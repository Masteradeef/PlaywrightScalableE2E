...
export abstract class BaseHomePageLocators {
  ...
  postalCodeInputLegacy = () => this.page.locator('.locationMainContainer #locationAddressV2');
  showMeCarsBtnLegacy = () => this.page.locator('.searchMainContainer #SearchButton');
