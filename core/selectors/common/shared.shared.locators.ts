...
export abstract class BaseSharedLocators {
  ...
  cookieBannerLegacyCloseButton = () => this.page.locator('#cookie-banner button.close-button');
  // #endregion
  ...
  myAccountDropdown=() => this.page.locator('div[data-type="account-links"]');
  favouritesLink = () => this.page.locator('.hfo-nav__submenu__items a[href$="/favorites"]');
  savedSearchesLink = () => this.page.locator('div.hfo-nav__account-links a[href$="/account/searches"]');
  ...
  savedSearchDeleteButton = () => this.page.getByRole('button', { name: /delete|supprimer/i });
  ...
  contentContainerOMP = (): Locator => this.page.locator('header#hfo-header-root');
  autoTraderLogo = (): Locator => this.page.locator('#as24-logo');
  // #endregion
  ...
  // #endregion
  // #region Legacy Trader Experience locators 
   legacyTraderExperienceButton = (): Locator => this.page.locator('button.btn.btn-remove');
   // #endregion
}
