...
import { PageType } from '../helpers/definitions/project.types';
...
import { DesktopDealerWebsiteWidgetPageActions } from './desktop/desktop.dealerWebsiteWidgetPage.actions';
import { DesktopETIFormActions } from './desktop/desktop.etiForm.actions';
import { DesktopMLCPageActions } from './desktop/desktop.mlcPage.actions';
import { DesktopListingsPageActions } from './desktop/desktop.listingsPage.actions';
import { DesktopPPPPageActions } from './desktop/desktop.pppPage.actions';
...
import { MobileDealerWebsiteWidgetPageActions } from './mobile/mobile.dealerWebsiteWidgetPage.actions';
import { MobileETIFormActions } from './mobile/mobile.etiForm.actions';
import { MobileMLCPageActions } from './mobile/mobile.mlcPage.actions';
import { MobileListingsPageActions } from './mobile/mobile.listingsPage.actions';
import { MobilePPPPageActions } from './mobile/mobile.pppPage.actions';
...
export class OperationHandler {
  ...
  private static actionRegistry: { [key: string]: { desktop: ActionClass, mobile: ActionClass } } = {
    ...
    dealerWebsiteWidgetPage: {
      desktop: DesktopDealerWebsiteWidgetPageActions,
      mobile: MobileDealerWebsiteWidgetPageActions
    },
    etiForm: {
      desktop: DesktopETIFormActions, 
      mobile: MobileETIFormActions 
    },
    mlcPage: {
      desktop: DesktopMLCPageActions,
      mobile: MobileMLCPageActions
    },
    listingsPage: {
      desktop: DesktopListingsPageActions,
      mobile: MobileListingsPageActions
    },
    pppPage: {
      desktop: DesktopPPPPageActions,
      mobile: MobilePPPPageActions
    }
    // leadForm: {
   ...
   * @returns Proxy object that delegates to appropriate pc/mobile implementation
   */
